...
function Carde() {
  ...
  <div class="container">
    ...
    <div class="grid gap-8 md:grid-cols-4">
      <div class="dark:bg-jacarta-800 rounded-2.5xl bg-white iinn p-6 text-center transition-shadow hover:shadow-xl">
        ...
        <p className='para_graph'>When you purchase a Jutto Club NFT, the art is yours, whether you want to sell it or use it in advertising</p>
      </div>
     ...
     <p className='para_graph'>By joining the Jutto Club, you will have access to every metaverse we enter. Plus there will be additional
	 perks within our metaverse Private members club for Jutto Club NFT holders</p>
      ...
      <div class="dark:bg-jacarta-800 rounded-2.5xl bg-white iinn p-6 text-center transition-shadow hover:shadow-xl">
        ...
        <p className='para_graph'>All Jutto Club NFTs are available as high-resolution jpegs,
	  ...
	  <div class="dark:bg-jacarta-800 rounded-2.5xl bg-white iinn p-6 text-center transition-shadow hover:shadow-xl">
        ...
        <p className='para_graph'>Make authentic connections and become a part of a global community that empowers
