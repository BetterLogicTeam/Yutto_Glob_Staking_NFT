      ...
      <main class="pt-[5.5rem] lg:pt-24 bnnr">
        ...
        <div class="container">
          ...
          <div class="mx-auto max-w-2xl py-16 text-center">
            <h1 class="font-display text-jacarta-700 mb-8 text-4xl font-medium dark:text-white banner_p" style={{color:"#fff"}}>About Jutto</h1>
            <p class="dark:text-jacarta-300  text-lg leading-normal" style={{color:"#fff"}}>
              An exclusive private<br></br>-members club by Jutoo.
            </p>
          </div>
        </div>
      </section>
